...
namespace gl3 {
    ...
    {
        style->button.normal = nk_style_item_image(getTileImage(textureAtlasID, 0, 11, 3, 1, 3072, 3072));
        style->button.hover = nk_style_item_image(getTileImage(textureAtlasID, 3, 11, 3, 1, 3072, 3072));
        style->button.active = nk_style_item_image(getTileImage(textureAtlasID, 6, 11, 3, 1, 3072, 3072));
    ...
    {
        style->option.normal = nk_style_item_image(getTileImage(textureAtlasID, 21, 11, 1, 1, 3072, 3072));
        style->option.hover = nk_style_item_image(getTileImage(textureAtlasID, 22, 11, 1, 1, 3072, 3072));
        style->option.active = nk_style_item_image(getTileImage(textureAtlasID, 23, 11, 1, 1, 3072, 3072));
        style->option.cursor_normal = nk_style_item_image(getTileImage(textureAtlasID, 24, 11, 1, 1, 3072, 3072));
        style->option.cursor_hover = nk_style_item_image(getTileImage(textureAtlasID, 25, 11, 1, 1, 3072, 3072));
    ...
    {
        style->progress.normal = nk_style_item_image(getTileImage(textureAtlasID, 0, 14, 3, 1, 3072, 3072));
        style->progress.cursor_normal = nk_style_item_image(getTileImage(textureAtlasID, 6, 14, 3, 1, 3072, 3072));
    }

    void GuiHandler::setStyleSlider(nk_style* style)
    {
        style->slider.normal = nk_style_item_image(getTileImage(textureAtlasID, 0, 6, 3, 1, 3072, 3072));
        style->slider.hover = nk_style_item_image(getTileImage(textureAtlasID, 0, 6, 3, 1, 3072, 3072));
        style->slider.active = nk_style_item_image(getTileImage(textureAtlasID, 0, 6, 3, 1, 3072, 3072));
        style->slider.cursor_normal = nk_style_item_image(getTileImage(textureAtlasID, 21, 12, 1, 1, 3072, 3072));
        style->slider.cursor_hover = nk_style_item_image(getTileImage(textureAtlasID, 22, 12, 1, 1, 3072, 3072));
        style->slider.cursor_active = nk_style_item_image(getTileImage(textureAtlasID, 23, 12, 1, 1, 3072, 3072));
    ...
    struct nk_image GuiHandler::getTileImage(GLuint texID, int tileX, int tileY, int tileWidth, int tileHeight, int atlasWidth, int atlasHeight)
    {
        return nk_subimage_id(texID, atlasWidth, atlasHeight,
